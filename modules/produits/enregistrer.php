    ...
    <div class="container mt-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <p class="text-muted">Avant d'enregistrer un produit, vous pouvez accéder à la facturation ou consulter la liste des produits existants.</p>
            </div>
            <div>
                <a href="facturation/nouvelle-facture.php" class="btn btn-primary me-2">🧾 Aller à la facturation</a>
                <a href="liste.php" class="btn btn-secondary">📋 Liste des produits</a>
            </div>
        </div>
